...
export const SHORTCUTS: readonly ShortcutDef[] = [
  ...
  { id: 'tile.new', keys: 'Ctrl+Shift+T', hint: 'ctrl+shift t', noun: 'tile', label: 'New tile', scope: 'node', strip: true },
  { id: 'project.add', keys: 'Ctrl+Shift+O', hint: 'ctrl+shift o', noun: 'project', label: 'Add project folder', scope: 'node' },
  { id: 'tile.close', keys: 'Ctrl+Shift+W', hint: 'ctrl+shift w', noun: 'close', label: 'Close focused tile', scope: 'node', strip: true },
  { id: 'tile.zoom', keys: 'Ctrl+Shift+Enter', hint: 'enter zoom', noun: 'zoom', label: 'Zoom focused tile', scope: 'node', strip: true },
  ...
  { id: 'reviewer.focus', keys: 'Ctrl+Shift+0', hint: '0', noun: 'reviewer', label: 'Focus the reviewer', scope: 'node', strip: true },
  ...
  { id: 'search.project', keys: 'Ctrl+Shift+F', hint: 'ctrl+shift f', noun: 'search', label: 'Search in project', scope: 'editor', strip: true },
